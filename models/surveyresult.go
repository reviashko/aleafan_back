...
type SurveyResult struct {
	...
	FeedBackExists int    `json:"afanasiev_feedback" db:"afanasiev_feedback"`
}

// GetSurveyResult method
func (db *DB) GetSurveyResult(employeeid string) (*SurveyResult, pq.ErrorCode, error) {
...
func (db *DB) SaveSurveyFeedBack(employeeid string, surveyfeedback int) error {
